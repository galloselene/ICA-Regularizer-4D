...
class Abide1DConvNet(nn.Module):
    def __init__(self,  n_inputs=5, n_outputs=3, n_cluster=None,
        ...
        self.batchnorm1 = nn.BatchNorm1d(k_conv1_n, affine=True)
        self.conv2 = nn.Conv1d(k_conv1_n, k_conv2_n, 7,)
        self.batchnorm2 = nn.BatchNorm1d(k_conv2_n, affine=True)
    ...
    def forward(self, x, ica_matrix, training):
        x = F.relu(self.ICAGrouping(x, ica_matrix, training))
        x = self.batchnorm1(x)
